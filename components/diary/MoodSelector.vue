<template>
  <div class="flex items-center justify-between sm:justify-start gap-1 sm:gap-4 w-full">
    <button
      v-for="mood in moods"
      :key="mood.value"
      @click="selectMood(mood.value)"
      class="mood-btn flex flex-col items-center gap-1 sm:gap-2 p-1.5 sm:p-3 rounded-2xl transition-all duration-300 group flex-1 sm:flex-0"
