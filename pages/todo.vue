  ...
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="card divide-y divide-gray-100 dark:divide-slate-700/50">
      ...
      <div v-for="todo in sortedTodos" :key="todo.id" class="p-4 flex items-center gap-3 group hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
        ...
        <button v-if="!todo.completed" @click="confirmPostponeSingle(todo.id)" class="px-3 py-1 text-xs bg-amber-100 dark:bg-amber-900/30 text-amber-600 rounded-lg transition-all hover:bg-amber-200 dark:hover:bg-amber-900/50">
          延期
        </button>

        <button @click="confirmDeleteSingle(todo.id)" class="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all">
